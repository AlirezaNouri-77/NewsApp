...
import com.example.newsapp.Presentation.util.InternetConnectionInterceptor
...
class DiContainer(
		...
		private var databaseRepository = DatabaseRepository(database = newsRoomDataBase, modelMapper = modelMapper)
