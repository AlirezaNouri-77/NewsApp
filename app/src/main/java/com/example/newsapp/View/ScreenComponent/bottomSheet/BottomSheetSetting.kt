package com.example.newsapp.View.ScreenComponent.bottomSheet
...
fun BottomSheetSetting(
  ...
  val categoryState = newsViewModel.activeSection
  val settingsList = newsViewModel.settingList
  
  var settingIsChange by rememberSaveable {
	...
	LazyColumn(
	  ...
	  item {
		SettingPicker(
		  ...
		  listItem = ConstantData.languageList,
	  ...
	  item {
		SettingPicker(
		  ...
		  listItem = ConstantData.countryList,
		  settings = settingsList,
		  activeSetting = categoryState,
		)
	  }
	  item {
		SettingPicker(
		  ...
		  listItem = ConstantData.domainList,
		  settings = settingsList,
		  activeSetting = categoryState,
		)
	  }
